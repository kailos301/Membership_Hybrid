...
class APIController(http.Controller):
    ...
    @http.route('/api/jose/search_products/', methods=["GET"], type='http', auth='public', csrf=False)
    ...
    @http.route('/api/jose/create_product/', auth='public', type='http', methods=['POST'], csrf=False)
    ...
    @http.route('/api/jose/update_product/', type='http', auth='public', methods=['POST'], csrf=False)
